  ...
  <div class="row justify-content-evenly">
    ...
    <div class="col-md-5 offset-md-2 d-flex align-items-center">
      <div class="card-body">
        ...
        <div class="text-center fs-4 fw-bold mt-3 tx-sec-color"> Sei già registrato? <a href="{{route('login')}}" class="text-decoration-none tx-main-color">Entra Subito</a></div>
        <form method="POST" action="{{route('register')}}">
          @csrf
          <div class="mb-3">
              <label for="name" class="form-label"></label>
              <input name="name" type="text" class="form-control text-center" id="name" placeholder="Nome">
            </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
              ...
              <input name="password_confirmation" type="password" class="form-control text-center" id="exampleInputPasswordConfirm" placeholder="Conferma Password">
            </div>
