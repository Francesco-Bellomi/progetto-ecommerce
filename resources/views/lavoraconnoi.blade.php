    ...
    <div class="container-fluid py-2 mt-5 bg-work2">
        <div class="row">
            <div class="col-12 col-md-5 d-flex align-items-center text-center card ms-5">
                <div class="card-body">
                    <div class="text-center fs-1 fw-bold mt-3 tx-main-color">{{__('ui.lavora')}}</div>
                    <div class="text-center fs-4 fw-bold mt-3 tx-main-color">{{__('ui.richiedi')}}</div>
                    <form method="POST" action="{{route('lavoraconnoi.submit')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" id="exampleInputmessage" cols="36" class="form-control text-center sbar" rows="10"  placeholder="{{__('ui.scrivi')}}"></textarea>
                        </div>
