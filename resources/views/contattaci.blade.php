    ...
    <div class="container-fluid py-2 mt-5 bg-work2">
        <div class="row">
            <div class="col-12 col-md-5 d-flex align-items-center text-center card ms-5">
                <div class="card-body">
                    <div class="text-center fs-1 fw-bold mt-3 tx-main-color">Vuoi sapere dei nostri prodotti?</div>
                    <div class="text-center fs-4 fw-bold mt-3 tx-main-color">Per qualsiasi informazioni scrivici ciò che ti serve.</div>
